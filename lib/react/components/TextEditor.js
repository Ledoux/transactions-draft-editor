...
var TextEditor = function (_Component) {
  ...
  function TextEditor(props) {
    ...
    if (initialHtml) {
      contentState = (0, _utils.getContentStateFromHtml)(initialHtml);
    } else if (initialRaw) {
      contentState = (0, _draftJs.convertFromRaw)(typeof initialRaw === 'string' ? JSON.parse(initialRaw) : initialRaw);
    }
    var editorState = contentState ? _draftJs.EditorState.createWithContent(contentState) : _draftJs.EditorState.createEmpty();
    // state
  ...
  _createClass(TextEditor, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      var _props = this.props,
          onCurrentContentChange = _props.onCurrentContentChange,
          onEditorStateChange = _props.onEditorStateChange;
      ...
      if (editorState !== prevState.editorState && this._lastChangeType) {
        // prepare the payload
        var newChange = { divEditorElement: this.divEditorElement,
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          assetsPathTest = _props2.assetsPathTest,
          existsPath = _props2.existsPath,
          className = _props2.className,
          isControl = _props2.isControl,
          isScroll = _props2.isScroll,
      ...
      return _react2.default.createElement(
        ...
        isControl && _react2.default.createElement(_ControlsBar2.default, { editorState: editorState,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_draftJsPluginsEditor2.default, { assetsPathTest: assetsPathTest,
